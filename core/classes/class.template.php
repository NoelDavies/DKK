    ...
    private function make_filename($filename, $handle) {
        ...
        if(!$from_http) {
            ...
            if(!isset($this->override[$handle]) || $this->override[$handle] === true) {
                ...
                //module/
                $file[] = cmsROOT.'themes/'.$this->tpl.'/template/'.$explode[$cexplode - 6].'/'.$explode[$cexplode - 2].'/'.$explode[$cexplode - 1];

                //module/admin/
                $file[] = cmsROOT.'themes/'.$this->tpl.'/template/'.$explode[$cexplode - 4].'/'.$explode[$cexplode - 2].'/'.$explode[$cexplode - 1];

                //core/admin/
                $file[] = 'themes/'.$this->tpl.'/template/'.$file_name;
            ...
            if(!file_exists($filename)) {
                if(!file_exists(cmsROOT.'themes/default/'.$fname)) {
                    ...
                    return realpath(cmsROOT.'themes/default/'.$fname);
                }
            }
        }
